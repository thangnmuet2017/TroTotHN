...
$sql_select_all_action = 'SELECT * FROM gia_phong_tro LEFT JOIN dia_chi_phong_tro ON gia_phong_tro.IDPhongTro=dia_chi_phong_tro.IDPhongTro WHERE gia_phong_tro.KieuPhong="' .$action. '" ORDER BY gia_phong_tro.ThoiGianDang DESC';
$row_of_results = 0;
...
$sql_select_each_page = 'SELECT * FROM gia_phong_tro LEFT JOIN dia_chi_phong_tro ON gia_phong_tro.IDPhongTro=dia_chi_phong_tro.IDPhongTro WHERE gia_phong_tro.KieuPhong="' .$action. '" ORDER BY gia_phong_tro.ThoiGianDang DESC LIMIT ' .$this_page_first_result. ',' .$result_per_page;
