...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 20, 2019 at 11:49 AM
...
(20, 'Số 9, ngách 18, ngõ 133 Xuân Thủy, Cầu Giấy, Hà Nội', 'Dịch Vọng Hậu', 'Cầu Giấy', 'Bác Thúy', '0904563287'),
(21, 'Số 21, ngõ 133 Xuân Thủy, Cầu Giấy, Hà Nội ', 'Dịch Vọng Hậu', 'Cầu Giấy', 'Không xác định', '033765924');
...
--
ALTER TABLE `dia_chi_phong_tro`
  MODIFY `IDPhongTro` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=22;
